...
<head>
    ...
    <title>HRMS admin template</title>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul class="pb-5">
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <li>
                                    <a class="{{($currentRouteName == 'employee.all'?'active':'')}}"
                                        href="{{route('employee.all')}}">All Employees</a>
                                    </li>
                                <li>
                                    <a class="{{($currentRouteName == 'employee.holidays'?'active':'')}}"
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                ...
                                <li>
                                    ...
                                    href="{{route('employee.salary_view')}}"> Payslip </a>
                                </li>
